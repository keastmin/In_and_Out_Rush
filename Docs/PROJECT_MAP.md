...
마지막 대조: 2026-08-14, commit `9179813`
...
| Territory | 영역 상태와 확장, Chunk·Trail 전환 | `TerritorySystem`, `Territory`, `TerritoryVisible` | Grid, Fog, Resource, Monster, `build-chunk-territory` | [Territory](Features/Territory.md) |
